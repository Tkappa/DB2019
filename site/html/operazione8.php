...
<body>
  ...
  <div class="container cbody">
    ...
    $sql = "insert into richiestaSostituzione(ID, IDsede, costogiorn,costotrasf, stato, dataInizio, dataFine, descrizione) VALUES ('".$_POST["id"]."', '".$_POST["sede"]."','".$_POST["cgg"]."','".$_POST["ctr"]."', 'in attesa',CURDATE(), , '".$_POST["desc"]."' );"
    ...
    <a href="operazione8.html">Inserisci ancora </a>
  </div>
</body>
</html>
