...
<body>
  ...
  <div class="container cbody">
    ...
    $sql = "select * from richiestaSostituzione";
    ...
    $sql = "select * from richiestaAggiornamento";
    ...
    $sql = "select * from soddisfaSostituzione";
    ...
    $sql = "select * from soddisfaFormazione";
    ...
    <a href="operazione0.html">Inserisci ancora </a>
  </div>
</body>
</html>
