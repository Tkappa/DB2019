...
<body>
  ...
  <div class="container cbody">
    ...
    $sql = "insert into riparazione(ID, Sede,stato, dataInizio, dataFine, descrizione) values ( '".$_POST["id"]."','".$_POST["sede"]."','In attesa',CURDATE(),,'".$_POST["desc"]."')";
    ...
    <a href="operazione7.html">Inserisci ancora </a>
  </div>
</body>
</html>
