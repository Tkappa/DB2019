...
<body>
  ...
  <div class="container cbody">
    ...
    $sql = "select sede.PIva, sede.nome, paese.nome, paese.ISO FROM situata, sede, paese WHERE situata.sede = sede.PIva and paese.ISO='".$_POST["iso"]."'";
    ...
    <a href="operazione11.html">Inserisci ancora </a>
  </div>
</body>
</html>
